...
It recives a geometry\+\_\+msgs/2\+D\+Pose message which contains a X and Y position from the get\+Position node \index{command\+Manager@{command\+Manager}!callback\+Sta@{callback\+Sta}}
...
Callback function for the speck\+Perception subsriber. 

Which recives a string from \index{command\+Manager@{command\+Manager}!decision@{decision}}
...
This function chose randomly the next state of the \hyperlink{namespaceFSM}{F\+SM}. 
...
\hline
\end{DoxyParams}
\index{command\+Manager@{command\+Manager}!personX@{personX}}
\index{personX@{personX}!command\+Manager@{command\+Manager}}
...
\hline
\end{DoxyParams}
\index{command\+Manager@{command\+Manager}!personY@{personY}}
\index{personY@{personY}!command\+Manager@{command\+Manager}}
