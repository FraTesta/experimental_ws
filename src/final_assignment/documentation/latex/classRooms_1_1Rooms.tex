...
Explore function that returns a random position away from the rooms already visited. 

Basically it generate a random position and check if it belongs in the neighborhood of each detected room. \index{Rooms\+::\+Rooms@{Rooms\+::\+Rooms}!generate\+\_\+rand\+\_\+pos@{generate\+\_\+rand\+\_\+pos}}
...
\begin{DoxyParams}{Parameters}
{\em target\+\_\+room} & name of the desired room \\
\hline
\end{DoxyParams}
\index{Rooms\+::\+Rooms@{Rooms\+::\+Rooms}!mrange@{mrange}}
\index{mrange@{mrange}!Rooms\+::\+Rooms@{Rooms\+::\+Rooms}}
\subsubsection[{\texorpdfstring{mrange(self, a, l)}{mrange(self, a, l)}}]{\setlength{\rightskip}{0pt plus 5cm}def Rooms.\+Rooms.\+mrange (
\begin{DoxyParamCaption}
\item[{}]{self, }
\item[{}]{a, }
\item[{}]{l}
\end{DoxyParamCaption}
)}\hypertarget{classRooms_1_1Rooms_a8f7070d91a261e3d6b6f9be2ce78b96c}{}\label{classRooms_1_1Rooms_a8f7070d91a261e3d6b6f9be2ce78b96c}
